    ...
    def scrape_victims(self):
        with Proxy() as p:
            ...
            for victim in victim_list:
                ...
                if q.count() == 0:
                    # new victim
                    published = datetime.strptime(victim.published.split(",")[1], " %d %b %Y %H:%M:%S +0000")
                    description = BeautifulSoup(victim.description, "lxml").get_text()
